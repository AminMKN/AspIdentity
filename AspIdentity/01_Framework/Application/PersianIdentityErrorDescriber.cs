    ...
    public class PersianIdentityErrorDescriber : IdentityErrorDescriber
    {
        ...
        public override IdentityError PasswordRequiresDigit()
            => new IdentityError()
            {
                ...
                Description = $"کلمه عبور باید حداقل دارای یک عدد باشد"
            };
        ...
        public override IdentityError PasswordRequiresLower()
            => new IdentityError()
            {
                ...
                Description = $"کلمه عبور باید حداقل دارای یک کاراکتر انگلیسی کوچک باشد ('a'-'z')"
            };
        ...
        public override IdentityError PasswordRequiresUpper()
            => new IdentityError()
            {
                ...
                Description = $"کلمه عبور باید حداقل دارای یک کاراکتر انگلیسی بزرگ باشد ('A'-'Z')"
            };
        ...
        public override IdentityError PasswordRequiresNonAlphanumeric()
            => new IdentityError()
            {
                ...
                Description = $"کلمه عبور باید حداقل دارای یک کاراکتر ویژه باشد مثل '@#%^&'"
            };
        ...
        public override IdentityError PasswordRequiresUniqueChars(int uniqueChars)
            => new IdentityError()
            {
                ...
                Description = $"کلمه عبور باید حداقل دارای {uniqueChars} کاراکتر منحصر به فرد باشد"
            };
        ...
        public override IdentityError PasswordTooShort(int length)
            => new IdentityError()
            {
                ...
                Description = $"کلمه عبور نباید کمتر از {length} کاراکتر باشد"
            };
